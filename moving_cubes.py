...
#정육면체의 꼭짓점 위치를 랜덤으로 정한다.
#중심이 (0,0,0)인 정육면체를 기준으로 더하고 빼준다.
def set_vertices(max_distance):
    x_value_change = random.randrange(-11,11)
    y_value_change = 0#random.randrange(-11,11)
...
def myOpenGL():
    ...
    while True:
        ...
        for cube_vertices in cube_dict:
            drawCube(cube_dict[cube_vertices])
